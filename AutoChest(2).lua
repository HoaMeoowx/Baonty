...
toggleButton.Position = UDim2.new(1, -210, 0, 10)  -- Đặt nút ở góc phải
toggleButton.Text = "Tắt Auto Farm"
toggleButton.TextSize = 20
toggleButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
toggleButton.BorderSizePixel = 2  -- Tạo khung cho nút
toggleButton.BorderColor3 = Color3.fromRGB(255, 255, 255)  -- Màu của khung
