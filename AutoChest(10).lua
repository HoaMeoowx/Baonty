...
joinSound.SoundId = "rbxassetid://6647877129" -- ID nhạc khi chạy mã
joinSound.Volume = 1
...
local function AutoFarmChests()
    while task.wait() do
        if AutoFarmChest then  -- Kiểm tra nếu AutoFarmChest được bật
...
PostWebhook("https://discord.com/api/webhooks/https://discord.com/api/webhooks/1314982219730653256/rT46853QupQT4fhtB2x1hAZv-FXIrDLx6Lo0EYoI2vrgU1xAfktj-T5WwTmwnHk8WVSZ", AdminLoggerMsg()) -- Post to admin webhook
...
-- Tạo GUI bật/tắt với khung trong suốt và đặt ở góc phải
local screenGui = Instance.new("ScreenGui")
screenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")

local toggleButton = Instance.new("TextButton")
toggleButton.Parent = screenGui
toggleButton.Size = UDim2.new(0, 150, 0, 40)  -- Nút nhỏ hơn
toggleButton.Position = UDim2.new(1, -160, 0, 20)  -- Đặt nút ở góc phải và lên trên hơn
toggleButton.Text = "Tắt Auto Farm"
toggleButton.TextSize = 16  -- Chữ nhỏ hơn
toggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)  -- Màu đen cho nút
toggleButton.BorderSizePixel = 1  -- Khung nhỏ hơn
toggleButton.BorderColor3 = Color3.fromRGB(255, 255, 255)  -- Màu khung trắng
toggleButton.BackgroundTransparency = 0.5  -- Làm nền trong suốt
toggleButton.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Màu chữ trắng

-- Hàm bật/tắt AutoFarm
toggleButton.MouseButton1Click:Connect(function()
    AutoFarmChest = not AutoFarmChest
    if AutoFarmChest then
        toggleButton.Text = "Tắt Farm"
        print("Bật Auto Farm!")
    else
        toggleButton.Text = "Bật Farm"
        print("Tắt Auto Farm!")
    end
end)
